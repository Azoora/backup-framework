...
2. **Backup** -- Create consistent snapshot of each component:
   ...
   - RSA keys
   - Configuration file
3. **Verify** -- Test archive integrity via `tar -tzf`
4. **Post-backup** -- Clean up temporary files
...
[2026-07-10T12:00:05+0000] [SUCCESS] Backup completed for service: vaultwarden
```
